...
Owns /ping â€” samples player connection + server load to MySQL

| Field | Value |
|-------|-------|
| **Folder / artifact** | `root-ping` |
| **Version** | `1.7.1` |
| **Bukkit name** | `Root-Ping` |
| **Paper API** | `26.1` |
| **Author** | Root Record |
| **Website** | https://rootmc.net/plugins/ |
| **Main class** | `com.rootrecord.minecraft.rootping.RootPingPlugin` |

## Install

1. Install **[Root-Core](https://github.com/RootRecord/root-core)** first (license/cloud spine for the suite).
2. Download `root-ping-1.7.1.jar` from [Releases](https://github.com/RootRecord/root-ping/releases) or the [plugin catalog](https://rootmc.net/plugins/).
3. Remove any older `root-ping-*.jar` from `plugins/`.
...
.\build-with-server-jdk.bat :plugins:root-ping:jar
```
...
| Command | Description |
|---------|-------------|
| `/ping` | Show your ping and current server load |
...
| This plugin page | https://rootmc.net/plugins/root-ping/ |
...
| GitHub (this repo) | https://github.com/RootRecord/root-ping |
| Releases | https://github.com/RootRecord/root-ping/releases |
