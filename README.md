...
1. Purchase / download `root-ping-1.7.3.jar` from BuiltByBit (coming soon) or your licensed RootMC distribution channel.
...
| Releases (version notes) | https://github.com/RootRecord/root-ping/releases |
